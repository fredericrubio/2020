...
${OBJECTDIR}/Src/NHOCCParameters.o: Src/NHOCCParameters.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOCCParameters.o Src/NHOCCParameters.cpp
...
${OBJECTDIR}/Src/NHOConfiguration.o: Src/NHOConfiguration.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOConfiguration.o Src/NHOConfiguration.cpp

${OBJECTDIR}/Src/NHOMotorParameters.o: Src/NHOMotorParameters.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOMotorParameters.o Src/NHOMotorParameters.cpp

${OBJECTDIR}/Src/NHORoverParameters.o: Src/NHORoverParameters.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHORoverParameters.o Src/NHORoverParameters.cpp
