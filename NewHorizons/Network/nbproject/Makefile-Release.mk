...
${OBJECTDIR}/Src/NHOAckMessage.o: Src/NHOAckMessage.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOAckMessage.o Src/NHOAckMessage.cpp

${OBJECTDIR}/Src/NHOBroadcastEmitter.o: Src/NHOBroadcastEmitter.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOBroadcastEmitter.o Src/NHOBroadcastEmitter.cpp

${OBJECTDIR}/Src/NHOCameraDataMessage.o: Src/NHOCameraDataMessage.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOCameraDataMessage.o Src/NHOCameraDataMessage.cpp

${OBJECTDIR}/Src/NHOEmitter.o: Src/NHOEmitter.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOEmitter.o Src/NHOEmitter.cpp
...
${OBJECTDIR}/Src/NHOImageSizeMessage.o: Src/NHOImageSizeMessage.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOImageSizeMessage.o Src/NHOImageSizeMessage.cpp

${OBJECTDIR}/Src/NHOMessage.o: Src/NHOMessage.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOMessage.o Src/NHOMessage.cpp

${OBJECTDIR}/Src/NHOMessageFactory.o: Src/NHOMessageFactory.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOMessageFactory.o Src/NHOMessageFactory.cpp

${OBJECTDIR}/Src/NHOReflexFullDuplexConnectedEmitter.o: Src/NHOReflexFullDuplexConnectedEmitter.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOReflexFullDuplexConnectedEmitter.o Src/NHOReflexFullDuplexConnectedEmitter.cpp

${OBJECTDIR}/Src/NHOTCMessage.o: Src/NHOTCMessage.cpp
	${MKDIR} -p ${OBJECTDIR}/Src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Src/NHOTCMessage.o Src/NHOTCMessage.cpp
